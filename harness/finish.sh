...
node harness/gen-plan-index.mjs   # đồng bộ docs/plans/INDEX.md (cùng cò với STATUS — tránh INDEX trôi)
...
echo "  • Ghi harness/handoff.md (đã làm/đang dở/bẫy/việc kế) → regen: node harness/gen-status.mjs + node harness/gen-plan-index.mjs."
