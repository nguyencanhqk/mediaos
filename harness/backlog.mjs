...
export const backlog = [
...

  {
    ...
    notes: [
      ...
      "❓ BA QUYẾT ĐỊNH CHỜ NGƯỜI (chặn vòng plan 2): (1) step-up có nhận recovery code không (khuyến nghị KHÔNG); (2) yếu tố xác thực lại là mật khẩu, TOTP, hay cả hai; (3) danh sách cặp reveal-class nào được mint window + route nào ĐƯỢC gắn lại `requiresReauth`. Cả ba là quyết định sản phẩm/bảo mật, không suy ra được từ code.",
    ],
  },
