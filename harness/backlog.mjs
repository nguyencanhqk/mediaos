...
export const backlog = [
  ...
  },
  {
    ...
    src: [
      ...
      "Census 2026-07-29: 40+ điểm chiếu users.email/users.fullName ở 7 module (attendance · leave · dashboard · employees · permission/role-admin · auth · org). Phần lớn CÓ ép scope theo resource của module mình; chỗ đáng soi trước: permission/role-admin.repository.ts:158-159 và org.repository.ts:332-333",
    ...
    done_when: [
      ...
      "ĐO PROD trước khi siết từng module: role nào giữ cặp nào ở scope nào, ai mất quyền xem so với hôm nay",
