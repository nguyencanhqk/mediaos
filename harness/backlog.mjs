...
export const backlog = [
  ...
  },
  {
    ...
    layer: "SEC",
    title:
      "KI-045 — 459 khoá ngoại MỘT-CỘT nối hai bảng tenant: FK check bỏ qua RLS ⇒ gắn được hàng của mình trỏ sang bản ghi của tenant khác (lớp lỗ, không phải bug lẻ)",
    zone: "red",
    status: "todo",
    paths: [
      "apps/api/migrations/**",
    ...
    done_when: [
      ...
      "FULL gate security-reviewer + rls-tenant-isolation-tester; RELEASE-02 KI-045 đóng kèm số đo trước/sau",
    ],
  },
  {
    id: "S6-SEC-MV-1",
