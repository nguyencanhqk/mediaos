...
# đặt ở tier mặc định.
step "tooling-tests (node --test)" node --test scripts/lib/ops-alert-rules.test.mjs scripts/lib/backup-db-resolve.test.mjs harness/lane-db-guard.test.mjs harness/reconcile-merged.test.mjs
