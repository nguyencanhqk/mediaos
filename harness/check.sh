...
# đặt ở tier mặc định.
step "tooling-tests (node --test)" node --test scripts/lib/ops-alert-rules.test.mjs scripts/lib/ops-alert-notify.test.mjs scripts/lib/ops-log-window.test.mjs scripts/lib/backup-db-resolve.test.mjs harness/lane-db-guard.test.mjs harness/reconcile-merged.test.mjs harness/chunk-bisect.test.mjs harness/spec-file-re.test.mjs harness/id-uniqueness.test.mjs
