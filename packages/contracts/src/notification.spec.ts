 ...
 * (0479 → +Goal 0507 → +Training 0529 → +Chat 0538 → +Asset 0551 → +Room 0555 → +Recruit 0561). Mảng LITERAL chép từ migration `0561`, cố ý
...
describe("contracts/notification — notificationTypeEnumSchema mirror CHECK notifications.notification_type", () => {
  it("== chk_notifications_notification_type sau mig 0561 (17 giá trị)", () => {
