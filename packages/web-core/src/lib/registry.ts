...
export const ROUTE_REGISTRY: readonly RouteMeta[] = [
  ...
  // S5-ME-FE-3 — APPEND 6 route "Công việc của tôi/Thông báo/Cài đặt cá nhân" (SPEC-09 §8.1, ME-SCREEN-
  // 009..014). Gate GIỮ literal `access:me` (KHÔNG qua PERMISSION_CODE_TO_PAIR — cùng kỹ thuật
  // me.overview): mỗi trang chỉ TỔNG HỢP từ meApi.*Summary/getPreferences (đã mask/section-status ở
  // BE) — KHÔNG gọi thẳng endpoint bảng nguồn (ATT/LEAVE/TASK), nên KHÔNG cần cặp module nguồn ở đây.
  {
    routeKey: "me.attendance",
    path: "/me/attendance",
    layout: "MODULE_WORKSPACE",
    moduleCode: "ME",
    screenCode: "ME-SCREEN-009",
    titleKey: "routeTitle.meAttendance",
    requiredAnyPermissions: ["access:me"],
    showInSidebar: true,
    order: 66,
  },
  {
    ...
    layout: "MODULE_WORKSPACE",
    moduleCode: "ME",
    screenCode: "ME-SCREEN-010",
    titleKey: "routeTitle.meLeave",
    requiredAnyPermissions: ["access:me"],
    showInSidebar: true,
    order: 67,
  },
  {
    ...
    layout: "MODULE_WORKSPACE",
    moduleCode: "ME",
    screenCode: "ME-SCREEN-011",
    titleKey: "routeTitle.meTasks",
    requiredAnyPermissions: ["access:me"],
    showInSidebar: true,
    order: 68,
  },
  {
    ...
    layout: "MODULE_WORKSPACE",
    moduleCode: "ME",
    screenCode: "ME-SCREEN-012",
    titleKey: "routeTitle.meNotifications",
    requiredAnyPermissions: ["access:me"],
    showInSidebar: true,
    order: 69,
  },
  {
    ...
    titleKey: "routeTitle.mePreferencesNotifications",
    requiredAnyPermissions: ["access:me"],
    showInSidebar: true,
    order: 70,
  },
  {
    ...
    titleKey: "routeTitle.mePreferencesAppearance",
    requiredAnyPermissions: ["access:me"],
    showInSidebar: true,
    order: 71,
  },
