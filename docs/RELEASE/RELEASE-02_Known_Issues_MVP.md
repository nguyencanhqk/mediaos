...
| KI-010 | Endpoint cũ `GET /employees` chưa phân trang thật (mới chặn bằng cap 2000) | S3 | Sản phẩm | ❌ | ❌ | WO `S10-HR-EMPPAGE-1` (seed 24/08 — Sprint 6 đã đóng mà món này chưa từng có WO) |
