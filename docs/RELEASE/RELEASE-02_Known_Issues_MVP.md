...
`S2 = **7 mở**` (KI-008 · KI-011 · KI-016 · KI-021 · **KI-025** · KI-029 · KI-041) — **KI-037 rời danh sách 2026-07-29**, đóng bởi `S6-QA-TENANTWRITE-1` (9→8); **KI-045 rời danh sách 2026-07-29**, đóng bởi `S6-SEC-ROTATE-1` (8→7) · `S3 = **18**` (thêm **KI-046**, mở 2026-07-29 từ chính lưới GHI mới).
