...
> **Bổ sung 2026-08-31** theo SPEC-11 PAYROLL (wave S13-PAYROLL, Phase 2 «HR nâng cao» — owner duyệt 31/08/2026, **chưa bắt đầu code**). Story PL-01..10 của `docs/plans/S13-PAYROLL-WAVE.md` §4 ánh xạ 1-1 sang IMP02-STORY-181..190. Trace: `S13-PAYROLL-DOC-1 → DB-1 → BE-1 → BE-2 → FE-1 → QA-1 → DASH-1`.
