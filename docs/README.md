...
Đây là **mục lục trung tâm** của toàn bộ bộ tài liệu dự án. Tài liệu được tổ chức thành 7 nhóm:
...
## 10. Tài liệu vận hành, quản trị & quyết định
...
## 11. Kế hoạch triển khai, Baseline & Issue Board
...
## 12. Tài liệu sẽ bổ sung sau

| Mã | Tên tài liệu | Trạng thái |
| -- | ------------ | ---------- |
| TEST-01 | Test Plan | Sẽ viết sau (phần lớn đã phủ bởi QA-01 → QA-10) |
