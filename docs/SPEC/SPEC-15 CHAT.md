...
> [SPEC-01 Tổng quan](<SPEC-01 Tổng quan.md>) · [SPEC-02 AUTH](<SPEC-02 AUTH.md>) · [SPEC-03 HR](<SPEC-03 HR.md>) · [SPEC-04 ATT](<SPEC-04 ATT.md>) · [SPEC-05 LEAVE](<SPEC-05 LEAVE.md>) · [SPEC-06 TASK](<SPEC-06 TASK.md>) · [SPEC-07 DASH](<SPEC-07 DASH.md>) · [SPEC-08 NOTI](<SPEC-08 NOTI.md>) · [SPEC-09 ME](<SPEC-09 ME.md>) · [SPEC-10 GOAL](<SPEC-10 GOAL.md>) · [SPEC-11 PAYROLL](<SPEC-11 PAYROLL.md>) · [SPEC-12 RECRUIT](<SPEC-12 RECRUIT.md>) · [SPEC-13 ASSET](<SPEC-13 ASSET.md>) · **SPEC-15 CHAT**
>
...
| Panel phụ (CHAT-SCREEN-002 v2) | **Drawer phải 400px** mở từ badge header trên mọi trang **trừ chính `/chat*`**: ô tìm + chip · danh sách thu gọn ↔ hội thoại (push) · vẫn **đúng 1 hội thoại** mở tại một thời điểm · ⤢ mở `/chat`. Thay cửa sổ nổi. Dưới `md` drawer thành toàn màn; `/chat` responsive 3 → 2 → 1 cột | CHAT-DEC-026 |
...
| CHAT-SCREEN-002 | **Drawer phải 400px** (v2, CHAT-DEC-026) | Thay cửa sổ nổi cũ: mở từ **badge header trên mọi trang — TRỪ chính `/chat` và `/chat/*`**, ở đó badge là **chỉ báo TĨNH** (drawer và trang cùng mount `useChatConversation` cho một phòng thì cái unmount trước sẽ tắt lưới bù tin của cái còn sống và cắt lịch sử về 200 tin; trang đã là khung nhìn đầy đủ nên chồng drawer lên nó không đổi lấy được gì) — ô tìm + chip lọc (§9a) · danh sách thu gọn ↔ hội thoại (push, ‹ quay lại) · ⤢ mở `/chat`. **Dưới `md` drawer thành toàn màn.** **GIỮ NGUYÊN**: **đúng 1 hội thoại mở tại một thời điểm** — bấm phòng khác thì THAY CHỖ phòng đang mở (đổi 2026-08-05 từ "tối đa 3"); **dùng chung store + chung 1 kết nối WS** với CHAT-SCREEN-001 |
