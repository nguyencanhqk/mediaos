...
**Branch:** `feat/g7-workflow` (main dir `c:/dev 2/MediaOS`) · 1a…3c + ⑥ gate + 4a + 4b + **4c (`119a94a` migration 0036 + `e539938` eval hook)** **đã push (origin đồng bộ)** · **DB dev ở migration 0036**. **LUỒNG A spine (1a→4c) HOÀN TẤT.** Viên kế = gate tổng + PR (§8) HOẶC nợ residual (xem cuối file + §10).
