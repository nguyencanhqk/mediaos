...
| --- | --- | --- | --- | --- | --- |
| `S17-CHAT-UX2-DOC-1` | DOCS | 🟡 LIGHT | — | Hoà DEC-021..027 vào SPEC-15 (§5.1d · §9 sửa SCREEN-001/002/004 «v2» · §9a bổ sung chip · §10 FUNC-022..026 · §15 API-031 + `kind` ở API-017 · §22c), API-13 §5, DB-12 ghi «0 migration», UI doc màn chat, README §8 | plan-reviewer PASS; grep 0 dòng còn nói DM «không có tên trong danh sách» |
