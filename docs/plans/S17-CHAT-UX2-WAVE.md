...
| --- | --- | --- | --- | --- | --- |
| `S17-CHAT-UX2-DOC-1` | DOCS | 🟡 LIGHT | — | ✅ **XONG** — Hoà DEC-021..027 vào SPEC-15 (§9 sửa SCREEN-001/002/004 «v2» · §9a bổ sung chip · §10 FUNC-022..026 · §12 nới CHAT-ERR-016 · §14 trạng thái UI · §15b API-031 + `kind` ở API-017 — **§5.1d giữ 0 dòng đổi**), API-13 §5/§5.1d/§7, DB-12 §6.8 «0 migration», UI-09 §13a, README §9 hàng CHAT | plan-reviewer PASS; grep 0 dòng còn nói DM «không có tên trong danh sách» hoặc «panel nổi 1 phòng» |
