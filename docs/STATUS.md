...
> Sinh bởi `harness/gen-status.mjs` lúc **2026-08-05 03:43Z**. Status TỰ ĐỘNG từ ledger (start-on-touch · finish-on-commit); đóng dấu tay: `node harness/ledger.mjs start|done <WO>`. Cơ cấu WO (title/zone/paths/deps) sửa ở `harness/backlog.mjs`.

## Tiêu điểm phiên (đang làm)

### 🔴 S7-CHAT-QA-1 — Bộ test trọn vẹn CHAT: 12 nhóm scenario SPEC-15 §21 trên LANE_DB + E2E luồng tới hạn + coverage ≥80% (vùng membership/tìm kiếm cao hơn)
- **zone**: red · **skills**: code-review
- **sửa ở đâu (paths)**: `apps/api/test/integration/**`, `apps/api/src/chat/**`, `apps/app/src/**`, `docs/QA/**`, `docs/plans/S7-CHAT-QA-1.md`
- **phụ thuộc**: S7-CHAT-FE-3✓, S7-CHAT-BE-5✓, S7-CHAT-BE-6✓, S7-CHAT-FE-4✓, S7-CHAT-FE-5✓
...
| `67d3c10e` | 2026-08-04 | feat(chat): S7-CHAT-FE-3 — panel chat nổi toàn hệ thống + badge tổng chưa đọc (CHAT-SCREEN-002/006) (#338) |
| `fcc716eb` | 2026-08-04 | docs(chat): đánh giá hợp nhất chat LMS → module CHAT chung — đo trước, đề xuất sau |
| `5b721133` | 2026-08-04 | feat(chat): S7-CHAT-FE-2 — trang /chat full-screen 3 cột (CHAT-SCREEN-001/003/004) (#336) |
| `1c4c246c` | 2026-08-04 | docs(status): regen sau khi S7-CHAT-FE-1 (#334) + chore(deps) advisory HIGH (#335) land — READY = S7-CHAT-FE-2 |
