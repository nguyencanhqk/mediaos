...
> Sinh bởi `harness/gen-status.mjs` lúc **2026-08-20 00:52Z**. Status TỰ ĐỘNG từ ledger (start-on-touch · finish-on-commit); đóng dấu tay: `node harness/ledger.mjs start|done <WO>`. Cơ cấu WO (title/zone/paths/deps) sửa ở `harness/backlog.mjs`.
...
| `cdd0a747` | 2026-08-18 | test(att): spec cảnh báo vắng mặt hết đỏ theo GIỜ — cửa sổ quét là [today-1, today] (S10-QA-ATTNOTIFLAKE-1) (#393) |
| `5edc5228` | 2026-08-18 | fix(sec): mọi khoá Valkey mang envScope — 16 họ khoá hết rò chéo môi trường (S10-FND-VALKEYSCOPE-1 · KI-067) (#391) |
| `42062607` | 2026-08-18 | docs(devops): chốt 2 quyết định cuối của S10-SOCIAL-OPS-1 — xoá bản lùi, hoãn bản ngoài máy |
| `9b572ad0` | 2026-08-18 | docs(devops): tác vụ sao lưu fbpost trỏ về cây chính + gỡ worktree (S10-SOCIAL-OPS-1) |
