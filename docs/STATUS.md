...
> Sinh bởi `harness/gen-status.mjs` lúc **2026-07-26 06:07Z**. Status TỰ ĐỘNG từ ledger (start-on-touch · finish-on-commit); đóng dấu tay: `node harness/ledger.mjs start|done <WO>`. Cơ cấu WO (title/zone/paths/deps) sửa ở `harness/backlog.mjs`.
...
- **zone**: yellow
- **sửa ở đâu (paths)**: `docs/QA/**`, `docs/RELEASE/**`, `docs/plans/S5-UAT-1.md`
- **phụ thuộc**: S5-QA-E2E-1✓, S5-QA-REG-1✓, S5-SEC-1✓
