...
> Sinh bởi `harness/gen-status.mjs` lúc **2026-07-24 04:23Z**. Status TỰ ĐỘNG từ ledger (start-on-touch · finish-on-commit); đóng dấu tay: `node harness/ledger.mjs start|done <WO>`. Cơ cấu WO (title/zone/paths/deps) sửa ở `harness/backlog.mjs`.
...
| `c1c60ebc` | 2026-07-24 | test(qa): E2E xuyên module 1 luot lien mach + smoke checklist P0 (S5-QA-E2E-1) (#274) |
| `f2722da3` | 2026-07-24 | feat(goal): widget dashboard "Mục tiêu kỳ này" BE+FE + khối goal ở trang phòng ban (S5-GOAL-DASH-1) (#273) |
| `a31ed377` | 2026-07-24 | chore(harness): regen STATUS — reconcile ledger S5-LMS-FE-1 + S5-SYS-CLEAN-1 sang done |
| `be5eae32` | 2026-07-24 | feat(lms): FE /me card Đào tạo + trang /me/training (proxy tiến độ LMS, gate access:lms) [S5-LMS-FE-1] (#269) |
| `697766a3` | 2026-07-24 | feat(sysclean): retention CÓ NGƯỠNG cho system_job_runs — SECURITY DEFINER purge fn (S5-SYS-CLEAN-1) (#270) |
