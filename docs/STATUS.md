...
- 🟡 `S8-CHAT-UX-BE-1` Tuỳ chọn per-phòng: ghim/bỏ ghim (trần 10) · tắt thông báo (muted_until — CÓ CỘT TỪ 0538 mà 0 đường ghi) · đánh dấu chưa đọc
...
- `S8-CHAT-UX-FE-2` Mục Ghim + menu ngữ cảnh mỗi hội thoại (ghim · tắt thông báo · đánh dấu chưa đọc · lưu trữ) + avatar trong danh sách + màn đặt avatar ở RoomInfoPanel ⏳ cần: S8-CHAT-UX-BE-1, S8-CHAT-UX-BE-2
