...
> Sinh bởi `harness/gen-status.mjs` lúc **2026-08-12 17:20Z**. Status TỰ ĐỘNG từ ledger (start-on-touch · finish-on-commit); đóng dấu tay: `node harness/ledger.mjs start|done <WO>`. Cơ cấu WO (title/zone/paths/deps) sửa ở `harness/backlog.mjs`.
...
| `6dbd0e55` | 2026-08-12 | fix(ops): cảnh báo vận hành hết mù với fbpost :3500 và LMS :3400 — trước đó một app live chết 500 suốt 15 tiếng mà 8/8 nhóm vẫn xanh (#376) |
...
| `79d5ffcb` | 2026-08-11 | feat(chat): gateway /ws-call — allowlist ĐÓNG 8 sự kiện, relay SDP/ICE không đọc-không lưu (S7-CALL-RT-1) (#371) |
