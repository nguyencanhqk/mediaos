...
> Sinh bởi `harness/gen-status.mjs` lúc **2026-07-26 03:28Z**. Status TỰ ĐỘNG từ ledger (start-on-touch · finish-on-commit); đóng dấu tay: `node harness/ledger.mjs start|done <WO>`. Cơ cấu WO (title/zone/paths/deps) sửa ở `harness/backlog.mjs`.

## Tiêu điểm phiên (đang làm)

### 🟡 S5-LMS-NOTI-2 — LOCAL apps/lms — đẩy sự kiện học tập về NOTI của MediaOS (ghi danh được duyệt · bài thi chấm xong · khoá mới gán · sắp tới hạn) qua intake nội bộ, và dọn chồng lấn với chuông thông báo local để người dùng không nhận đôi
- **zone**: yellow · **skills**: code-review
- **sửa ở đâu (paths)**: `apps/lms/**`, `apps/api/src/integrations/lms/**`, `docs/plans/S5-LMS-NOTI-2.md`
- **phụ thuộc**: S5-LMS-NOTI-1✓
...
| `5663343a` | 2026-07-26 | chore(docs): regen STATUS sau merge #290 (S5-GOAL-TPL-1) |
| `40fe8d7d` | 2026-07-26 | feat(goal): S5-GOAL-TPL-1 — danh mục việc mẫu + phân rã mục tiêu 1 transaction (GOAL-API-011/012) (#290) |
| `7d4b1d92` | 2026-07-26 | chore(docs): regen STATUS sau merge #289 (S5-FND-THEME-AA-1) |
| `235e0ea5` | 2026-07-26 | fix(ui): S5-FND-THEME-AA-1 — kéo token trượt AA lên ≥4.5 tại nguồn theme.css (#289) |
| `366d0b9d` | 2026-07-25 | docs(devops): đưa bước MIGRATE fail-closed vào lối khởi động (dev.bat · menu · dev/README) |
| `3ab4b18a` | 2026-07-25 | chore(docs): regen STATUS sau merge #288 (S5-DEVOPS-DEPLOYMIG-1) |
