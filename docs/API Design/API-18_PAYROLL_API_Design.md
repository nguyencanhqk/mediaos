...
- **Thiết kế DB:** [DB-13 PAYROLL Database Design](<../DB/DB-13 PAYROLL Database Design.md>) (§5 bản đồ reconcile · **§12–§14 bản v2**: 3 ALTER · 11 bảng mới · enum v2 · RLS/GRANT · migration `0570+` · seed catalog/tỉ lệ/mẫu mặc định) · [DB-09 §8.19](<../DB/DB-09 Database Index Query Pattern Performance Design.md>) · [DB-10 seed PAYROLL](<../DB/DB-10_Migration_Plan_Initial_Seed_Data_Database_Design.md>).
