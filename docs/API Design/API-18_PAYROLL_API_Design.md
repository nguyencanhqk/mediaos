...
| **PAYROLL-API-059..085** | ❌ **Chưa hiện thực** | **v2 (wave S15-PAYROLL-V2)** — track C `S15-PAYROLL-BE-4` (059–077) · track D `S15-PAYROLL-BE-5` (078–085). Phụ thuộc `S15-PAYROLL-DB-2` |
