...
> **Chưa migrate (`S15-PAYROLL-DB-2`) — 4 bảng:** `payroll_advances` · `payroll_payment_batches` · `payroll_payment_lines` · `payroll_budgets`. Thêm chúng thuộc chính WO đó, **cùng lượt với migration tạo bảng**.
