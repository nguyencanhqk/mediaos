...
**Chưa có (không phải bug):** widget «Lịch họp hôm nay» trên Dashboard (SPEC-14 §20) — cần WO riêng cho module
DASH · e2e qua UI (đặt → trùng → đổi giờ → huỷ) · **sửa lượt đặt**: v1 không có `PATCH`, muốn đổi giờ/phòng thì
