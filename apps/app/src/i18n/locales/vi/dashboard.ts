...
export default {
  ...
  payrollBudget: {
    title: "Ngân sách lương năm",
    empty: { title: "Chưa lập ngân sách lương năm nay" },
    fiscalYear: "Năm {{year}}",
    plannedLabel: "Kế hoạch",
    actualLabel: "Thực hiện",
    varianceLabel: "Chênh lệch",
    usageLabel: "Đã dùng {{pct}}%",
    usageUnknown: "Chưa lập kế hoạch",
    overBudget: "Vượt kế hoạch",
  },
  payrollAdvancePending: {
    title: "Tạm ứng chờ duyệt",
    empty: { title: "Không có tạm ứng chờ duyệt" },
    countLabel_one: "đề nghị chờ duyệt",
    countLabel_other: "đề nghị chờ duyệt",
    cta: "Xem danh sách tạm ứng",
  },
  typeSwitcher: {
