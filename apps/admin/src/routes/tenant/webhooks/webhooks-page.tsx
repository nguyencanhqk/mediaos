...
/**
 * AC-6 Webhooks — self-service TENANT. view:webhook để đọc (xem danh sách + delivery log), manage:webhook
 * để tạo/xoá/đăng ký (is_sensitive ở BE; UI chỉ ẩn/hiện affordance). Secret hiển thị MỘT LẦN ở
 * CreateWebhookDialog (state local). loading/error/empty + pagination qua DataTable.
 */
