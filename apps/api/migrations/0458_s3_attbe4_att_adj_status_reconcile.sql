-- Migration 0458: S3-ATT-BE-4-MIG (🔴 red-zone, crown) — reconcile attendance_adjustment_requests
...
--
-- BAND 0458 (lane S3-ATT-BE-4-MIG / db-migration). Journal: idx 138, when 1717500685000
--   (> head 0457 idx 137 / 1717500680000, S3-ATT-BE-3 shift/rule — landed feat/s3-wave3 trước, renumber
--   khi rebase do worktree tạo trên mergeBase cũ trùng 0457). NỐI TIẾP ĐƠN ĐIỆU sau head thực tế
--   0457_s3_attbe3_shift_rule_audit_object_type.
-- ════════════════════════════════════════════════════════════════════════════════════════════════
