...
// (mutable, soft-delete — app SELECT,INSERT,UPDATE, KHÔNG DELETE) + SỔ candidate_stage_events (APPEND-ONLY:
// SELECT,INSERT duy nhất) + interviews (không soft-delete, huỷ = Cancelled) + interview_participants (chỉ
