...
const PENDING_CODES: ReadonlyMap<string, string> = new Map([
  ...
  // CHAT-ERR-024 · CHAT-ERR-025 đã TRẢ ở `S8-CHAT-UX-BE-3` (06/08/2026) — gỡ khỏi đây để census quay
  // lại đòi mỗi mã ≥1 ca int-spec. Ca "nợ đã trả" bên dưới ép việc gỡ này, không phải trí nhớ ai đó.
]);
