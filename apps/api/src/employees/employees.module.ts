...
@Module({
  imports: [
    ...
    LmsSyncModule,
    // S7-CHAT-BE-5: ChatDerivedRoomsSyncService cho 9 điểm ghi phía nhân viên (W8a-W14). Một hướng —
    // ChatModule KHÔNG import EmployeesModule (job đọc thẳng `employee_profiles` bằng SQL).
    ChatModule,
