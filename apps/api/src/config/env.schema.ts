...
export const envSchema = z
  .object({
    ...
    // Admin/company khởi tạo KHÔNG còn seed-lúc-khởi-động (các *BootstrapService cũ đã gỡ khi de-media-fy).
    // Tài khoản admin tạo qua SCRIPT idempotent `apps/api/seed-admin.mjs` (dev: demo-seed-base.mjs) — đọc
    // ADMIN_EMAIL/ADMIN_PASSWORD/ADMIN_COMPANY_SLUG từ env, KHÔNG validate ở schema này. Xem `m deploy-seed`.
