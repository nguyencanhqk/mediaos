 ...
 *   (a) SAU migrate: 0 template GLOBAL còn `target_url_template IS NULL` + tổng đúng 45 (39 + 2 GOAL của 0507
 *       + 4 LMS của 0529) + sample-map khớp §4.
  ...
  () => {
    ...
    it("(a) 0 template GLOBAL còn target_url_template NULL + tổng đúng 47 (QA2-CRIT-001 fixed)", async () => {
      ...
      expect(
        ...
        "0481 (36) + 0490 (3) + 0507 (2 GOAL) + 0529 (4 LMS) + 0538 (2 CHAT) + 0551 (3 ASSET) + 0555 (3 ROOM) + 0561 (4 RECRUIT) + 0566 (4 PAYROLL) + 0573 (4 PAYROLL v2) + 0581 (9 SOCIAL) = 74 template global",
      ).toBe(74);
    });
