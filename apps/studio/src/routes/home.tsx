...
export function HomePage() {
  ...
  // App tách (FS-3) chỉ có subset category → chỉ render chip của các category THỰC SỰ có app,
  // tránh chip "ma" (hr/attendance/payroll/system) lọc ra rỗng gây hiểu nhầm app hỏng (silent-failure gate).
