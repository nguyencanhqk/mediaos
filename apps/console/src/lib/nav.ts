...
// Bảng màu ô icon launcher — tông sáng (-400) trên nền "Phòng điều khiển" navy để đọc rõ.
export const NAV_ITEMS: readonly NavItem[] = [
  // — Hệ thống —
  { id: "platformAccounts", labelKey: "platformAccounts", to: "/settings/platform-accounts", icon: KeyRound, tile: "bg-slate-500/15 text-slate-300", category: "system" },
  { id: "breakGlass", labelKey: "breakGlass", to: "/settings/break-glass", icon: ShieldAlert, tile: "bg-red-500/15 text-red-400", category: "system" },
  ...
  { id: "myAccount", labelKey: "myAccount", to: "/settings/account", icon: UserCircle, tile: "bg-emerald-500/15 text-emerald-400", category: "system" },
  { id: "accountSecurity", labelKey: "accountSecurity", to: "/settings/security", icon: ShieldCheck, tile: "bg-emerald-500/15 text-emerald-400", category: "system" },
  { id: "companySettings", labelKey: "companySettings", to: "/settings/company", icon: Settings, tile: "bg-slate-500/15 text-slate-300", category: "system" },
  // CS-8: Cấu hình mail server (SMTP, secret) — tenant self-service, permission configure-mail:company.
  { id: "mailConfig", labelKey: "mailConfig", to: "/settings/mail-config", icon: Mail, tile: "bg-cyan-500/15 text-cyan-400", category: "system" },
  ...
  { id: "securityPolicy", labelKey: "securityPolicy", to: "/settings/security-policy", icon: ShieldCheck, tile: "bg-emerald-500/15 text-emerald-400", category: "system" },
  // CS-1: Nhật ký hoạt động — subcategory "Kiểm toán" mở khoá sidebar 2 cấp cho console.
  { id: "activityLog", labelKey: "activityLog", to: "/system/activity-log", icon: ClipboardList, tile: "bg-violet-500/15 text-violet-400", category: "system", subcategory: "Kiểm toán" },
  // CS-3: Quản lý danh mục — Cơ cấu tổ chức + Vị trí công việc.
  { id: "orgStructure", labelKey: "orgStructure", to: "/system/org-structure", icon: Building2, tile: "bg-blue-500/15 text-blue-400", category: "system", subcategory: "Quản lý danh mục" },
  ...
  { id: "usageStats", labelKey: "usageStats", to: "/system/usage", icon: BarChart2, tile: "bg-blue-500/15 text-blue-400", category: "system", subcategory: "Tình hình sử dụng" },
  // CS-6: Thùng rác — khôi phục nhân viên bị xoá mềm (restore:employee sensitive).
  { id: "recycleBin", labelKey: "recycleBin", to: "/recycle-bin", icon: Trash2, tile: "bg-zinc-500/15 text-zinc-300", category: "system" },
  ...
  { id: "apiKeys", labelKey: "apiKeys", to: "/system/api-keys", icon: Terminal, tile: "bg-sky-500/15 text-sky-400", category: "system", subcategory: "DevOps" },
  { id: "webhooks", labelKey: "webhooks", to: "/system/webhooks", icon: Webhook, tile: "bg-teal-500/15 text-teal-400", category: "system", subcategory: "DevOps" },
] as const;
