...
/**
 * Thu role khỏi 1 user (DELETE /permissions/users/:id/roles/:roleId). CS-2 (mirror apps/admin tenant/rbac).
 *
 * ⚠️ BE KHÔNG có read-API liệt kê role hiện tại của user → chọn role từ danh mục (BE trả 404 nếu user không
 * giữ role đó). Gate ở BE: `assign-role:user` (isSensitive).
 */
